...
public class controladorVistaAgenda {
    @FXML
    private TableView<PersonaModelo> personaTabla;
    @FXML
    private TableColumn<PersonaModelo, String> nombreColumna;
    @FXML
    private TableColumn<PersonaModelo, String> apellidoColumna;
    ...
    private void showPersonDetails(PersonaModelo persona) {
        if (persona != null) {
    ...
    private void handleNewPerson() {
        PersonaModelo tempPerson = new PersonaModelo();
    ...
    PersonaModelo selectedPerson = personaTabla.getSelectionModel().getSelectedItem();
    ...
    // GUARDAR EN UNA BASE DE DATOS LOS INGRESADOS
